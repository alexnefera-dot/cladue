...
/* ---------- tab: новые группы ---------- */
function tabNew(){
  return `<div class="blk"><h2>12pages_withdate — запущена, позиций ещё нет</h2>
  <p class="note">Формат — 12 страниц с датами. Тот же, что у <b>D273</b>, рекордсмена архива:
  8,17 ВЧ+СЧ на домен и 83 % зашедших доменов. Первая попытка воспроизвести его
  после пересчёта.</p>
  <div class="tw"><table><thead><tr><th class="l">Группа</th><th class="l">Контенты</th>
  <th class="l">Шаблон</th><th>Дом</th><th>.team</th><th class="l">Статус</th></tr></thead><tbody>
    <tr><td class="l id">12pages_withdate · Theme1</td>
      <td class="l">12pages_withdate_20.08_11…18 · id 758-765</td>
      <td class="l"><b>Theme1</b></td><td>8</td><td>7</td>
      <td class="l good">домены привязаны</td></tr>
    <tr><td class="l id">12pages_withdate · Theme2</td>
      <td class="l">12pages_withdate_20.08_1…10 · id 748-757</td>
      <td class="l"><b>Theme2</b></td><td class="mut">—</td><td class="mut">—</td>
      <td class="l warn">ждём домены</td></tr>
  </tbody></table></div>
  <p class="note" style="margin-top:10px">Домены Theme1:
  <span class="num">2008vu.buzz, p3zv.team, f6bz.team, 1908.team, 1236.team, jmbt.team,
  fhmv.team, cgvz.team</span></p></div>

  <div class="blk"><h2>Зачем это разбиение</h2>
  <div class="cards">
    <div class="card ok"><h3>Первое чистое сравнение шаблонов</h3>
      <p>Один формат, один генератор, одна партия контентов, разные шаблоны.
      Всё, кроме темы, совпадает.</p>
      <p>В парах Generator_v5 / Generator_v4_2 сравнение шаблонов было испорчено
      разной версией генератора — здесь этой проблемы нет.</p></div>
    <div class="card acc"><h3>И повтор рекордного формата</h3>
      <p>D273 дал 8,17 на 12 доменах. Две половины по 8 домена — это 16, больше,
      чем было у самого D273.</p>
      <p class="mut">Считать половины и по отдельности (шаблон),
      и вместе (повтор формата).</p></div>
    <div class="card err"><h3>Чего ждать по архиву</h3>
      <p>Две партии одного формата в текущем тесте разошлись в 6 раз
      (Generator_11page против Generator_11page_2).</p>
      <p>Если половины 12pages_withdate разойдутся так же, разницу шаблонов
      от разницы партий отделить не выйдет.</p></div>
  </div></div>

  <div class="blk"><h2>Как считать, когда придут позиции</h2>
  <ul class="cl">
    <li><b>Theme1 против Theme2</b> — по .team-подмножествам, ждём состав второй половины.</li>
    <li><b>Обе половины вместе против D273</b> — повтор формата 12 страниц с датами.
      Сравнивать только на одинаковом номере замера: у D273 их было три.</li>
    ...
    <li><b>Не судить раньше третьего замера.</b> D273 на замере 2 стоял на 0,20
      и был предпоследним в архиве — через замер стал первым с 8,17.</li>
  </ul></div>

  <div class="blk"><h2>Именование</h2>
  <p class="note">Группы называются по одному из своих контентов. Номера групп сохранены
  как вторичная метка — под ними идут листы в выгрузках позиций.</p>
  <div class="tw"><table><thead><tr><th class="l">Имя</th><th class="l">Лист выгрузки</th>
