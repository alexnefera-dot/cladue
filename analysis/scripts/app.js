...
/* ---------- tab: новые группы ---------- */
function tabNew(){
  return `<div class="blk"><h2>Четыре группы на подходе</h2>
  ...
  <th>Дом</th><th>.team</th><th>.buzz</th><th class="l">прочие</th></tr></thead><tbody>
    ...
    <tr><td class="l id">Группа 4</td><td class="l">11 страниц #2, generator (5 контентов)</td>
      <td>5</td><td>4</td><td>0</td><td class="l mut">.cyou</td></tr>
    <tr class="tot"><td class="l">Итого</td><td class="l">30 доменов</td>
      <td>30</td><td>21</td><td>4</td><td class="l">5 экзотических</td></tr>
  </tbody></table></div>
  <p class="note" style="margin-top:10px">Группа 4 закрывает главную претензию к Группе 3:
  вместе они дают <b>10 доменов на 11 страницах</b> вместо пяти. Объединять можно
  при условии, что <span class="num">Generator_11page</span> и
  <span class="num">Generator_11page_2</span> — один генератор с одними настройками.</p></div>
  ...
  <div class="cards">
    ...
    <div class="card acc"><h3>Объём страниц — считать по .team</h3>
      ...
      Сравнение полных групп даст 11 страницам фору за счёт зоны, а не объёма.</p>
      <p class="mut">7 страниц: 6204, b2kn, m2wf, n4kd, r7mc, b8t<br>
      11 страниц: 4392, 1085, mpdg, gkrd, bdwn, j8vp, 3019, 2470, jkzq</p></div>
    <div class="card"><h3>Зоны — только сигнал</h3>
      <p>По одному домену на .quest, .bond, .icu, .top и .cyou.
      <b>.cyou в архиве не встречается ни разу</b> — история нулевая.
      При базовом «зашло» 30 % один домен ничего не доказывает.</p></div>
  </div></div>

  <div class="blk"><h2>Чего тест не покажет</h2>
  <ul class="cl">
    <li><b>Точную величину разницы.</b> На 9–10 доменах шанс поймать чемпиона около 40 %.
      Один такой домен сдвигает среднее по группе на +5–7, поэтому «11 страниц лучше в N раз»
      сказать не выйдет — только «лучше / хуже / не видно».</li>
    <li><b>Разницу между самими группами 3 и 4.</b> По 5 доменов в каждой; если они разойдутся,
      это не будет означать, что один набор контентов лучше другого.</li>
    <li><b>Работу экзотических зон.</b> Пять зон по одному домену — ни одна не наберёт статистики.
      Смотреть на Т30, а не на факт входа в ТОП-10.</li>
  ...
  <ul class="cl">
    <li><b>Гр.1 vs Гр.2</b> — полными группами, 10 против 10. Это основной результат теста.</li>
    <li><b>Гр.2(.team) vs Гр.3+4(.team)</b> — 6 против 9. Второй результат, слабее по мощности.</li>
    ...
    <li><b>Уточнить, одинаковы ли настройки</b> у Generator_11page и Generator_11page_2.
      Если разные — группы 3 и 4 не пулить.</li>
  </ul></div>`;
}
