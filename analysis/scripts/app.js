...
function tabNew(){
  ...
  <div class="blk"><h2>7pages_nodate — проба зон, не тест контента</h2>
  <p class="note">Отдельная группа, «рандомные домены». Четыре домена в четырёх разных зонах,
  шаблон Theme2, контенты из двух партий с разрывом почти в двое суток
  (MultiContentTest — 18.08 18:16, 7pages_nodate — 20.08 11:29).</p>
  <div class="tw"><table><thead><tr><th class="l">Домен</th><th class="l">Зона</th>
  <th>В группе</th><th>В архиве</th></tr></thead><tbody>
    <tr><td class="l num">cqrw.rest</td><td class="l">.rest</td><td>1</td><td class="bad"><b>0</b></td></tr>
    <tr><td class="l num">i182.xyz</td><td class="l">.xyz</td><td>1</td><td class="bad"><b>0</b></td></tr>
    <tr><td class="l num">5273r.cfd</td><td class="l">.cfd</td><td>1</td><td class="bad"><b>0</b></td></tr>
    <tr><td class="l num">lnwc.team</td><td class="l">.team</td><td>1</td><td class="good">433</td></tr>
  </tbody></table></div>
  <div class="cards" style="margin-top:14px">
    <div class="card err"><h3>Среднее по группе не читается</h3>
      <p>Зона — крупнейший фактор архива: .team даёт 1,70 ВЧ+СЧ на домен против 0,43
      у .casino, и внутри запусков выигрывает у .buzz в 4 случаях из 5.</p>
      <p>При одном домене на зону среднее определяется зоной, а не контентом.</p></div>
    <div class="card"><h3>Что она всё же даёт</h3>
      <p>Дешёвую разведку по трём зонам без истории. Читать по одному домену:
      взял ли он хоть что-то в Т30 — и всё.</p>
      <p><span class="num">lnwc.team</span> служит ориентиром: единственная зона
      с историей, по ней видно, работает ли связка контент+шаблон вообще.</p></div>
    <div class="card err"><h3>Чего делать нельзя</h3>
      <p>Записывать .rest, .xyz или .cfd в рабочие или нерабочие по одному домену.
      По архиву даже .buzz с 24 доменами дал разброс от нуля до 14 ВЧ+СЧ.</p>
      <p>И смешивать с 12pages_nodate — там 12 страниц и Theme1.</p></div>
  </div></div>
