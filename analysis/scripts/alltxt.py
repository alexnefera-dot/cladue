...
WEEK=['03.09','04.09','05.09','06.09','07.09','08.09','09.09']
w=build(WEEK,'СПИСОК ЗАПУСКОВ ЗА НЕДЕЛЮ  3–9 сентября 2026',
 ...
 'zapuski_nedeli_03-09.09.txt')

a=build(list(FILES),'СПИСОК ЗАПУСКОВ ЗА ВСЁ ВРЕМЯ  24 августа — 9 сентября 2026',
