...
FILES=collections.OrderedDict([
 ...
 ('14.09',['launch_14.09.txt']),('15.09',['launch_15.09.txt']),('16.09',['launch_16.09.txt']),
])
def pl(n,a,b,c):
    x=abs(n)%100; y=x%10
...
WEEK=['10.09','11.09','12.09','13.09','14.09','15.09','16.09']
w=build(WEEK,'СПИСОК ЗАПУСКОВ ЗА НЕДЕЛЮ  10–16 сентября 2026',
