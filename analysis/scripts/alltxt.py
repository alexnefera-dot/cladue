...
FILES=collections.OrderedDict([
 ...
 ('09.09',['launch_09.09.txt']),('10.09',['launch_10.09.txt']),('11.09',['launch_11.09.txt']),
])
def pl(n,a,b,c):
    x=abs(n)%100; y=x%10
...
WEEK=['05.09','06.09','07.09','08.09','09.09','10.09','11.09']
w=build(WEEK,'СПИСОК ЗАПУСКОВ ЗА НЕДЕЛЮ  5–11 сентября 2026',
 ...
 'zapuski_nedeli_05-11.09.txt')

a=build(list(FILES),'СПИСОК ЗАПУСКОВ ЗА ВСЁ ВРЕМЯ  24 августа — 11 сентября 2026',
