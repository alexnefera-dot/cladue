...
FILES=collections.OrderedDict([
 ...
 ('09.09',['launch_09.09.txt']),('10.09',['launch_10.09.txt']),('11.09',['launch_11.09.txt']),('12.09',['launch_12.09.txt']),('13.09',['launch_13.09.txt']),
 ('14.09',['launch_14.09.txt']),('15.09',['launch_15.09.txt']),('16.09',['launch_16.09.txt']),('17.09',['launch_17.09.txt']),
])
def pl(n,a,b,c):
    x=abs(n)%100; y=x%10
...
WEEK=['11.09','12.09','13.09','14.09','15.09','16.09','17.09']
w=build(WEEK,'СПИСОК ЗАПУСКОВ ЗА НЕДЕЛЮ  11–17 сентября 2026',
 ['По дням: группа, id, время создания, зоны, затем домены по одному в строке.',
  'В конце — общий плоский список всех доменов недели.','',
  'Неполные группы: 12.09 oform-3 — нет 2042-2043; 12.09 oform-1 — нет 1958;',
  '14.09 oform-1 — нет 2192-2204; oform-8 — нет _1…_24 и 2568;',
  '14.09 oform-9 — нет 2592-2596 и 2601-2605; 14.09b oform-2 — нет 2688-2704;',
  '14.09 content-2026-09-14-7str-oform-2 — группа названа, домены не присланы.'],
 'zapuski_nedeli_11-17.09.txt')

a=build(list(FILES),'СПИСОК ЗАПУСКОВ ЗА ВСЁ ВРЕМЯ  24 августа — 15 сентября 2026',
