...
WEEK=['08.09','09.09','10.09','11.09','12.09','13.09','14.09']
w=build(WEEK,'СПИСОК ЗАПУСКОВ ЗА НЕДЕЛЮ  8–14 сентября 2026',
 ['По дням: группа, id, время создания, зоны, затем домены по одному в строке.',
  'В конце — общий плоский список всех доменов недели.','',
  'Неполные партии: 08.09 archive37 часть1 — 25 из 45, часть3 — 27 из 45;',
  '12.09 content-...-7str-oform-3 — нет id 2042-2043 (_5, _6);',
  '12.09 content-...-7str-oform-1 — нет id 1958 (_4);',
  '14.09 content-2026-09-14-7str-oform-2 — группа названа, домены не присланы.'],
 'zapuski_nedeli_08-14.09.txt')

a=build(list(FILES),'СПИСОК ЗАПУСКОВ ЗА ВСЁ ВРЕМЯ  24 августа — 14 сентября 2026',
