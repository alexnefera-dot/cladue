...
function tSum(){
  ...
  ${c12.w} из ${c12.n} против ${c7.w} из ${c7.n}. Точный тест Фишера даёт <b>p = 0,45</b> —
  это ничто. Вместе со свежей проверкой на запусках 4–6 сентября
  (5 из 30 против 1 из 30) получается <b>25,2 % против 16,1 %, p = 0,088</b>:
  направление держится, но до порога не дотягивает.</p>
