...
ORD=['25.08 · контроль (контент 21.08)','25.08 · 12 стр без дат','25.08 · 12 стр + даты',
...
G=[grp([x for x in DOMS if x['g']==nm],nm,
       {'25.08 · контроль (контент 21.08)':'7 стр, контенты 21.08, чужой',
        ...
        '24.08 · без картинок':'тест B день 1, наш','24.08 · картинки':'тест B день 1, наш'}[nm]) for nm in ORD]
...
D={'labs':['24.08 22:24','25.08 11:09','25.08 23:21'],
   'doms':sorted(DOMS,key=lambda x:-x['t10']),'groups':G,'img':IMG,'dat':DAT,'aut':AUT,
