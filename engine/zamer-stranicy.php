...
$t=$argv[1]; $dir=$argv[2]??"/home/user/cladue/samples/v3-final/ruchnoy-256";
$a=new Analyzer(); $F=PageMetrics::fields(true);
$R=PageMetrics::measure($a,$t,file_get_contents("/home/user/cladue/samples/dorgen-reference/set256/$t.html"),["ru"=>"","en"=>""]);
