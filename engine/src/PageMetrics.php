...
final class PageMetrics
{
    ...
    public static function measure(Analyzer $a, string $type, string $raw, array $brand = ['ru' => '', 'en' => '']): array
    {
        ...
        return [
            ...
            // И «вы»-формы: набор на «вы» давал ноль призывов при цели 3–7 и валился
            // на трёх страницах из двенадцати каждым сидом.
            'cta' => preg_match_all('~\b(зарегистрируй(?:ся|тесь)|играй(?:те)?|жми(?:те)?|получи(?:те)?|забери(?:те)?|активируй(?:те)?|скачай(?:те)?|попробуй(?:те)?|переходи(?:те)?|успей(?:те)?)\b~ui', $flat),
