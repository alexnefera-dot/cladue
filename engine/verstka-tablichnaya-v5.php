...
$ТЕГИ = [
    'table'      => v5TemaShrift($Т, 15) . ';text-align:left;width:100%;border-collapse:separate;border-spacing:0;border:' . КАНТ . ';border-radius:12px;overflow:hidden;margin:0 0 20px;font-size:15px',
    'thead'      => 'background:' . ПОДЛОЖКА2,
    'th'         => 'color:inherit;font-family:inherit;font-size:inherit;text-align:left;padding:10px 12px;border-bottom:' . КАНТ . ';background:' . ПОДЛОЖКА2 . ';font-weight:600;white-space:nowrap',
    'td'         => 'color:inherit;font:inherit;padding:9px 12px;border-bottom:1px solid rgba(127,133,160,.18);vertical-align:top',
    'aside'      => ШРИФТ . ';text-align:left;display:block;border-left:4px solid ' . ЗОЛОТО . ';border-radius:0 12px 12px 0;background:' . ПОДЛОЖКА . ';padding:12px 16px;margin:0 0 20px',
    'blockquote' => ШРИФТ . ';text-align:left;margin:0 0 20px;padding:14px 18px;border:' . КАНТ . ';border-radius:12px;background:' . ПОДЛОЖКА . ';font-style:italic',
    'details'    => ШРИФТ . ';text-align:left;display:block;border:' . КАНТ . ';border-radius:12px;padding:10px 14px;margin:0 0 12px;background:' . ПОДЛОЖКА,
    'summary'    => 'color:inherit;font-family:inherit;font-size:inherit;cursor:pointer;font-weight:600;padding:2px 0',
    'h2'         => ШРИФТ . ';font-weight:700;text-align:left;margin:28px 0 12px;padding:0 0 8px;border-bottom:2px solid ' . ЗОЛОТО . ';font-size:24px;line-height:1.25',
    'h3'         => ШРИФТ . ';font-weight:700;text-align:left;margin:22px 0 10px;font-size:19px;line-height:1.3',
    'nav'        => ШРИФТ . ';text-align:left;display:block;border:' . КАНТ . ';border-radius:12px;background:' . ПОДЛОЖКА . ';padding:10px 14px;margin:0 0 20px',
    'time'       => 'color:inherit;font-family:inherit;display:inline-block;padding:2px 10px;border-radius:999px;background:' . ПОДЛОЖКА2 . ';font-size:13px',
    'cite'       => 'color:inherit;font-family:inherit;display:block;margin-top:8px;font-size:13px;opacity:.8;font-style:normal',
    'figure'     => 'margin:0 0 20px',
    'figcaption' => v5TemaShrift($Т, 13) . ';opacity:.8;margin-top:6px',
    'ul'         => ШРИФТ . ';font-weight:400;text-align:left;margin:14px 0;padding-left:22px;line-height:' . $Т['строка'] . ';list-style-type:' . $Т['маркер'],
    'ol'         => ШРИФТ . ';font-weight:400;text-align:left;margin:14px 0;padding-left:24px;line-height:' . $Т['строка'],
    'li'         => 'margin:0 0 6px;padding:0;color:inherit;font:inherit;text-align:inherit',
    'p'          => ШРИФТ . ';font-weight:400;text-align:left;line-height:' . $Т['строка'] . ';margin:0 0 14px',
];
if ($тема > 0) {
...
foreach ($файлы as $файл) {
    ...
    // ссылки меню — как чипы (раньше общего прохода: иначе li уже со style=)
