...
/** Словарь профильной лексики живёт в NicheLexicon — один на весь движок. */
...
foreach (glob($ROOT . '/*', GLOB_ONLYDIR) as $dir) {
    ...
    foreach ($types as $t => $f) {
        ...
        $proseText = NicheLexicon::prose($raw);
        ...
        $pages[$t] = [
            ...
            'providers_named' => NicheLexicon::countProviders($proseText),
            'games_named'     => NicheLexicon::countGames($proseText),
            ...
            'terms'          => NicheLexicon::termCounts($proseText),
            'terms_total'    => NicheLexicon::termsTotal($proseText),
