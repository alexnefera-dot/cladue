...
IMYA = re.compile(r'\b(Александр|Алексей|Анатолий|Андрей|Антон|Аркадий|Арсений|Артём|Артем|Артур|Богдан|Борис|Вадим|Валентин|Валерий|Василий|Виктор|Виталий|Владимир|Владислав|Всеволод|Вячеслав|Геннадий|Георгий|Герман|Глеб|Григорий|Даниил|Данил|Денис|Дмитрий|Евгений|Егор|Захар|Иван|Игнат|Игорь|Илья|Кирилл|Константин|Леонид|Макар|Максим|Марат|Марк|Матвей|Михаил|Никита|Николай|Олег|Павел|Пётр|Петр|Роман|Ростислав|Руслан|Савелий|Семён|Семен|Сергей|Станислав|Степан|Тарас|Тимофей|Тимур|Фёдор|Федор|Филипп|Эдуард|Юрий|Ярослав|Алина|Алла|Анастасия|Анна|Валерия|Вера|Вероника|Виктория|Галина|Дарья|Диана|Евгения|Екатерина|Елена|Жанна|Инна|Ирина|Кристина|Ксения|Лариса|Лидия|Любовь|Людмила|Маргарита|Марина|Мария|Надежда|Наталья|Оксана|Ольга|Полина|Раиса|Светлана|София|Тамара|Татьяна|Ульяна|Юлия|Яна)\b')
