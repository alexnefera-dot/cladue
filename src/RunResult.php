...
final class RunResult
{
    ...
    public array $stats = [
        ...
        'requests' => 0,
        'results' => 0,
        // Уникальных доменов и поддоменов в выдаче: результатов в разы больше — один сайт попадается
        // во множестве запросов, и сравнивать «результаты» с «сайтами» без этого числа нельзя.
        'hosts_total' => 0,
        'sites_total' => 0,
        'sites_selected' => 0,
        'rejected' => [],
