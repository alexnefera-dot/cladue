...
/**
 * User-Agent распространённых настольных браузеров.
 * В живой выдаче каждому прокси назначается один постоянный User-Agent,
 * при визитах на сайты — по одному на вариант.
 */
