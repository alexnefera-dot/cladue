...
// ===== Дневник настройки — объёмный образ себя: какой я / что делаю / что имею =====
export const TUNING_DIARY_STEPS = [
...
export function ensureTuningDiary(db) {
  seedTechnique(db, 'tune_v1', 'Дневник настройки', TUNING_DIARY_STEPS,
    'образ себя в настоящем времени: какой я · что делаю · что имею. Поля широкие, правится со временем');
}
