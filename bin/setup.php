...
const KEEP_FILES = ['config.php', '.env', 'proxies.txt', 'own-markers.txt', 'own-domains.txt', 'brands.txt', 'queries.txt', 'cache', 'out', 'runs', 'debug', 'node_modules', 'vendor', '.git'];
...
$copies = [
    ...
    'own-domains.example.txt' => 'own-domains.txt',
    'brands.example.txt' => 'brands.txt',
];
