...
# После названия слота может стоять ещё одно слово: «Evil Bet - популярный слот от Mascot».
SLOT_AFTER = re.compile(r"^[»\"']?\s*(?:\w+\s+)?(?:[-—–]\s*популярн|\(RTP|\(\d{4}\)|от\s+[A-Z]|с\s+RTP|—\s*слот|-\s*слот)")
...
BRAND_LINE = re.compile(r"^\s*<p>(?:Казино\s+|Casino\s+)?((?:[A-Z][A-Za-z0-9]+|[А-ЯЁ][А-Яа-яЁё0-9]+)(?:[ -](?!Casino\b|casino\b)(?:[A-Z][A-Za-z0-9]+|[А-ЯЁ][А-Яа-яЁё0-9]+))?)(?:\s+(?:Casino|casino|казино|Казино))?\.\s*</p>")
...
CYR_WHITELIST = {"актуальная", "актуальное", "актуальные", "альтернативный", "анонсы", "бонус",
    ...
    "минимальный", "минимальная", "лицензия", "лицензии", "стратегия", "стратегии",
    "пополнение", "платежи", "платёж", "гипотеза", "промокоды", "промокод", "выплаты",
    "депозит", "вывод", "служба", "оплата", "турнир", "турниры", "кэшбэк", "фриспины",
    "ставки", "игра", "игры", "игроки", "условия", "безопасность", "верификация",
    "техподдержка", "вопросы", "ответы", "итог", "вывод", "плюсы", "минусы",
    "демо", "день", "джекпот", "каскады", "классика", "множители",
    "новинка", "символы", "хит", "эксклюзив", "прогрессивный", "мегавыигрыши", "для", "доступ", "доступность", "если", "живые", "зайти", "зачем", "зеркала", "зеркало",
    "играйте", "играть", "игровые", "интернет", "информация", "используйте", "казино", "как", "когда",
    "кратко", "лицензированные", "личный", "лучшие", "мгновенные", "минимальная", "мобильное", "можно",
    "мой", "наличие", "новое", "новости", "обзор", "обновляются", "онлайн", "отзывы", "откройте",
    "открываю", "отсутствие", "официальное", "официальный", "перейдите", "плюсы", "поддержка",
    "подробная", "полный", "после", "почему", "правила", "приветственный", "приложение", "проверенное",
    ...
    "отсутствует", "сигналы", "внутри", "плюс"}
